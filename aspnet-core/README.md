...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 2083bc1a-0fc7-4846-aabd-1d8629533030
```

> `2083bc1a-0fc7-4846-aabd-1d8629533030` is the password of the certificate, you can change it to any password you want.
